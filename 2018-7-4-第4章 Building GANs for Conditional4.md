...
2. 点击AWS Marketplace，搜索 Deep Learning AMI with Source Code v2.0 (ami-bcce6ac4) AMI。这一AMI好好所有预先安装的软件：CUDA, cuDNN (https://developer.nvidia.com/cudnn), Tensorflow。
