...
knitr::opts_chunk$set(eval = TRUE,font="Courier New")
```
## 封面
...
Alexey Grigorev是一名数据科学家，机器学习工程师和8年以上专业经验的软件开发人员。他的职业生涯开始用不同规模公司的Java开发，然后转向了数据科学。现在，Alexey是Simplaex的数据科学家。他在日常工作中经常使用Java和Python进行数据清理，数据分析和建模。他的专业领域是机器学习和文本挖掘。
...
Rajalingappaa Shanmugamani是SAP新加坡公司的一名深度学习组长。之前，他在一些创业公司工作，开发计算机视觉产品。他拥有印度理工学院的硕士学位，毕业论文是关于制造业中的计算机视觉应用。他发表了多篇同行评议的期刊文章，并在会议上作报告，拥有几个机器学习的专利。闲暇时间，他给学生和工程师教授编程和机器学习。
...
=======
上述每个部分都是本章的关键点，按照上述顺序讲解有助于帮助读者理解。
>>>>>>> 7151f97a33a54653970e5c0e6ed5080a23d59f27
